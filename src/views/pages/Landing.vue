      ...
      <div
        ...
        <div
          ...
          <div class="flex border-t lg:border-t-0 border-surface py-4 lg:py-0 mt-4 lg:mt-0 gap-2">
            <Button label="Login" as="router-link" to="/auth/login" severity="success"></Button>
          </div>
        </div>
      </div>
          ...
          <div class="col-span-12 mt-20 mb-20 p-2 md:p-20 shadow-md" style="
            ...
            <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
              ...
              <p class="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-6" style="max-width: 800px">
                ...
                sapiente iste officia earum eligendi, deleniti enim beatae
                consectetur minima quaerat eaque, quibusdam cumque, accusamus
                numquam. Tempore nostrum quibusdam veritatis et.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-span-12 md:col-span-10 mt-6">
            <div class="grid grid-cols-12 gap-8 text-center md:text-left">
              <div class="col-span-12 md:col-span-3">
                ...
                <a
                  class="leading-normal text-xl block cursor-pointer text-white mb-2 text-surface-700 dark:text-surface-100">Get
                  Started</a>
                <a
                  class="leading-normal text-xl block cursor-pointer text-white mb-2 text-surface-700 dark:text-surface-100">Learn</a>
              </div>
              ...
              <div class="col-span-12 md:col-span-3">
                ...
                <a
                  class="leading-normal text-xl block cursor-pointer text-white mb-2 text-surface-700 dark:text-surface-100">Discord</a>
                <a
                  class="leading-normal text-xl block cursor-pointer text-white mb-2 text-surface-700 dark:text-surface-100">FAQ</a>
                <a
                  class="leading-normal text-xl block cursor-pointer text-white text-surface-700 dark:text-surface-100">Blog</a>
              </div>
